...
- (void)setCurrentDate:(NSDate *)currentDate
{
    ...
    NSDateComponents *comps = [calendar components:NSMonthCalendarUnit fromDate:currentDate];
        NSDateComponents *comps2 = [calendar components:NSYearCalendarUnit fromDate:currentDate];
    ...
    for(int i = 0; i < NUMBER_PAGES_LOADED; ++i){
        ...
        [monthView setMonthIndex:monthIndex year:currentyear];
    }
}
...
- (void)loadPreviousMonth
{
    ...
    // Update monthView
    {
        ...
        NSInteger currentMonthIndex = comps.month;
        NSDateComponents *comps2 = [calendar components:NSYearCalendarUnit fromDate:self.currentDate];
        NSInteger currentYear = comps2.year;
