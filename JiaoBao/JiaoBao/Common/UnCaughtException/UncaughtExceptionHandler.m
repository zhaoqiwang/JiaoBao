...
//    NSString *errorMessagex = [[exception userInfo] objectForKey:UncaughtExceptionHandlerAddressesKey];
    ...
    NSString *temp = [NSString stringWithFormat:@"TEST--教宝--号:%@,   版本号:%@,     系统版本号:%f     界面:%@,   bug:%@",[[NSUserDefaults standardUserDefaults]objectForKey:@"UserName"],versionNum,[[[UIDevice currentDevice] systemVersion] floatValue],[[NSUserDefaults standardUserDefaults] valueForKey:BUGFROM],errortemp];
