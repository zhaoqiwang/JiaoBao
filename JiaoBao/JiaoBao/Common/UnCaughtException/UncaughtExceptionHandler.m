...
//    NSString *errorMessagex = [[exception userInfo] objectForKey:UncaughtExceptionHandlerAddressesKey];
    ...
    NSString *temp = [NSString stringWithFormat:@"TEST--求知--版本号:%@,     系统版本号:%f     界面:%@,   bug:%@",versionNum,[[[UIDevice currentDevice] systemVersion] floatValue],[[NSUserDefaults standardUserDefaults] valueForKey:BUGFROM],errortemp];
