...
- (void)viewDidLoad {
    ...
    //获取我提出的问题列表
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"MyQuestionIndexWithnumPerPage" object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(MyQuestionIndexWithnumPerPage:) name:@"MyQuestionIndexWithnumPerPage" object:nil];
    
    //添加导航条
    self.mNav_navgationBar = [[MyNavigationBar alloc] initWithTitle:@"我提出的问题"];
    ...
    //发送请求
    [[KnowledgeHttp getInstance] MyQuestionIndexWithnumPerPage:@"10" pageNum:@"1" RowCount:@"0"];
    [MBProgressHUD showMessage:@"加载中..." toView:self.view];
}

//获取我提出的问题列表
-(void)MyQuestionIndexWithnumPerPage:(NSNotification *)noti{
...
-(void)sendRequest{
    ...
    [[KnowledgeHttp getInstance] MyQuestionIndexWithnumPerPage:@"10" pageNum:page RowCount:rowCount];
}
