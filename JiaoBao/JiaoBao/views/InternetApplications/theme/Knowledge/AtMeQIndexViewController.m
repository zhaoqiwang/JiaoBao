...
@interface AtMeQIndexViewController ()

@end

@implementation AtMeQIndexViewController
...
- (void)viewDidLoad {
    ...
    //添加导航条
    self.mNav_navgationBar = [[MyNavigationBar alloc] initWithTitle:@"邀请我回答的问题"];
    ...
    //发送请求
    [[KnowledgeHttp getInstance] AtMeQIndexWithnumPerPage:@"10" pageNum:@"1" RowCount:@"0"];
    [MBProgressHUD showMessage:@"加载中..." toView:self.view];
}

//邀请我回答的问题
-(void)AtMeQIndexWithnumPerPage:(NSNotification *)noti{
